...
func (r *cartRepository) Create() error {
	...
	l.Info("initial cart document has been created with the id : ", c.ID)
...
func (r *cartRepository) AddVasItemToItemByItemID(itemId string, vasItem *domain.VasItem) error {
	now := time.Now()
